...
class MarvelNavItem extends StatelessWidget {
  final String label;
  ...
  Center _makeLabel(String label,BuildContext context) {
    ...
    return Center(
      child: Text(
        ...
        style: TextStyle(
          ...
          letterSpacing: isSelected ? 1.2 : 0,wordSpacing: 0,decorationThickness: 0.2,
        ),textDirection: Directionality.of(context),overflow: TextOverflow.ellipsis,maxLines: 1,
        softWrap: true,
      ),
    );
  }
  ...
  Widget _makeIcon(
    ...
    return Icon(
      ...
      color: isSelected
          ...
          : theme.unselectedItemIconColor,size:isSelected? itemWidth/2+5:itemWidth/2.1,
    );
  }
  ...
  Widget build(BuildContext context) {
    theme = Provider.of<MarvelNavTheme>(context);
    ...
    double topOffset = isSelected ? -20 : -1;
    double iconTopSpacer = isSelected ? 0: 8;
    double shadowTopSpacer = 4;

    Widget labelWidget = _makeLabel(label,context);
